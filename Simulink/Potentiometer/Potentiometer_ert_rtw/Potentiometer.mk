###########################################################################
## Makefile generated for Simulink model 'Potentiometer'. 
## 
## Makefile     : Potentiometer.mk
## Generated on : Thu Mar 21 10:21:14 2019
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Potentiometer.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/alessandrosebastianelli/Desktop/Arduino-Matlab/Simulink/Potentiometer
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Potentiometer.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/shared/svd/include -I$(START_DIR)/Potentiometer_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -I/Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/include -I/Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I/Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I/Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_STANDARD = -DMODEL=Potentiometer -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : $(START_DIR)/Potentiometer_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/Potentiometer_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Potentiometer_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
MW_ArduinoHWInit.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


arduinoAVRScheduler.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


ext_svr_daemon.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c
	$(CC) $(CFLAGS) -o $@ $<


rtiostream_serial_daemon.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


daemon_checksum.o : /Users/alessandrosebastianelli/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) -o $@ $<
