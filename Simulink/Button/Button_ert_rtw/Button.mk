###########################################################################
## Makefile generated for Simulink model 'Button'. 
## 
## Makefile     : Button.mk
## Generated on : Thu Mar 21 10:09:27 2019
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Button.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/alessandrosebastianelli/Desktop/Arduino-Matlab/Simulink/Button
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Button.elf
...
DEFINES_STANDARD = -DMODEL=Button -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : $(START_DIR)/Button_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/Button_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Button_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
