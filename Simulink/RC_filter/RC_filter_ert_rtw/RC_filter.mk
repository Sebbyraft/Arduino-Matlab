...
## Generated on : Thu Mar 21 10:49:22 2019
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RC_filter.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/alessandrosebastianelli/Desktop/Arduino-Matlab/Simulink/RC_filter
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RC_filter.elf
...
%.o : $(START_DIR)/RC_filter_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/RC_filter_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/RC_filter_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
